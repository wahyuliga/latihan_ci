    ...
    <div class="box">
     <div class="box-header with-border">
           <h3 class="box-title">Tambah Data Sekolah</h3>
			...
			<div class="box-body">
			<form action="<?php echo base_url(). 'sekolah/tambah_aksi'; ?>" method="post">
				<table class="table-condensed">
				<tr>
					<td><label for="nama">Nama Sekolah</label></td>
					<td><input class="form-control" type="text" name="sekolah" size="70"></td>
				</tr>
				<tr>
